    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-orange-50 to-white p-8">
        <div className="max-w-6xl mx-auto">
          <Link href="/" className="text-orange-500 hover:underline mb-4 block">
            ← Volver al inicio
          </Link>
          <div className="text-center py-12">
            <h1 className="text-3xl font-bold text-gray-800 mb-4">Parque no encontrado</h1>
            <p className="text-gray-600">Lo sentimos, el parque que buscas no existe.</p>
          </div>
        </div>
      </div>
    )
                  ...
                  return (
                    <tr key={i} className="border-b hover:bg-gray-50">
                      ...
                      <td className="px-4 py-2">
                        <span className={`${bgColor} px-3 py-1 rounded-full text-xs font-semibold`}>
                          {lote.estado}
                        </span>
                      </td>
                    </tr>
